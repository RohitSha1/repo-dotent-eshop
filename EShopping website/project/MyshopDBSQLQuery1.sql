...
insert into tblUsers Values('karn','123','karn@gmail.com','Nisha Karn','Admin')
insert into tblUsers Values('nisha','123','nisha@gmail.com','nisha','User')
...
insert into tblBrands values('Tanisq ')
insert into tblBrands values('Tayani ')
insert into tblBrands values('Malabar  ')
insert into tblBrands values('Nesca ')
select * from tblCategory
INSERT into tblCategory values('Neckpiece')
INSERT into tblCategory values('Earing')
INSERT into tblCategory values('Ring')
INSERT into tblCategory values('Bracelet')

select * from tblSubCategory
insert into tblSubCategory values('Choker',1)
insert into tblSubCategory values('Golden Necpiece',1)
insert into tblSubCategory values('Silver neckpiece',1)
insert into tblSubCategory values('Oxidised Neckpiece',1)
insert into tblSubCategory values('Jhumka',2)
insert into tblSubCategory values('Gold Earing',2)
insert into tblSubCategory values('Silver Earing',2)
insert into tblSubCategory values('Chand Balis',2)
insert into tblSubCategory values('Silver Ring',3)
insert into tblSubCategory values('Golden Ring',3)
insert into tblSubCategory values('Band Ring',3)
insert into tblSubCategory values('Signet Ring',3)
insert into tblSubCategory values('Golden Bracelet',4)
insert into tblSubCategory values('Chain Bracelet',4)
insert into tblSubCategory values('Silver Bracelet',4)
insert into tblSubCategory values('Ghungroo Bracelet',4)
select * from tblGender
insert into tblGender values('Golden')
insert into tblGender values('Silver')

select * from tblProducts
insert into tblProducts values('Tanisq  Indian Jewellery brand',1899.00,799.00,1,2,3,1,'For high Quality Jewelry','For high Quality Jewelry','100% steriline',1,1,1)
insert into tblProducts values('Tayaani  one of the first polki brand to be internationally accredited.',1299.00,546.00,2,2,1,1, 'one of the first polki brand to be internationally accredited.','one of the first polki brand to be internationally accredited.','99% Platinum',1,1,1)
insert into tblProducts values('Malabar  Malabar Gold and Diamonds is a BIS certified Indian jewellery group',1699.00,649.00,3,3,4,2,' Malabar Gold and Diamonds is a BIS certified Indian jewellery group','Product Details    Malabar Gold and Diamonds is a BIS certified Indian jewellery group','100% Diamond',1,1,1)
insert into tblProducts values('Nesca   All Type Of Women Artificial Jewelery Especially Oxidised Jewelery',1330.00,450.00,4,4,5,2,'All Type Of Women Artificial Jewelery Especially Oxidised Jewelery','Product Details    All Type Of Women Artificial Jewelery Especially Oxidised Jewelery','100% Oxidised',1,1,1)

select * from tblProductImages
insert into tblProductImages values(1,'Tanisq  Indian Jewellery brand','.jpeg')
insert into tblProductImages values(1,'Tanisq  Indian Jewellery brand','.jpeg')
insert into tblProductImages values(1,'Tanisq  Indian Jewellery brand','.jpeg')
insert into tblProductImages values(1,'Tanisq  Indian Jewellery brand','.jpeg')
insert into tblProductImages values(1,'Tanisq  Indian Jewellery brand','.jpeg')

insert into tblProductImages values(2,'Tayaani  one of the first polki brand to be internationally accredited.','.jpeg')
insert into tblProductImages values(2,'Tayaani  one of the first polki brand to be internationally accredited.','.jpeg')
insert into tblProductImages values(2,'Tayaani  one of the first polki brand to be internationally accredited.','.jpeg')
insert into tblProductImages values(2,'Tayaani  one of the first polki brand to be internationally accredited.','.jpeg')
insert into tblProductImages values(2,'Tayaani  one of the first polki brand to be internationally accredited.','.jpeg')

insert into tblProductImages values(3,'Malabar  Malabar Gold and Diamonds is a BIS certified Indian jewellery group','.jpeg')
insert into tblProductImages values(3,'Malabar  Malabar Gold and Diamonds is a BIS certified Indian jewellery group','.jpeg')
insert into tblProductImages values(3,'Malabar  Malabar Gold and Diamonds is a BIS certified Indian jewellery group','.jpeg')
insert into tblProductImages values(3,'Malabar  Malabar Gold and Diamonds is a BIS certified Indian jewellery group','.jpeg')
insert into tblProductImages values(3,'Malabar  Malabar Gold and Diamonds is a BIS certified Indian jewellery group','.jpeg')

insert into tblProductImages values(4,'Nesca   All Type Of Women Artificial Jewelery Especially Oxidised Jewelery','.jpeg')
insert into tblProductImages values(4,'Nesca   All Type Of Women Artificial Jewelery Especially Oxidised Jewelery','.jpeg')
insert into tblProductImages values(4,'Nesca   All Type Of Women Artificial Jewelery Especially Oxidised Jewelery','.jpeg')
insert into tblProductImages values(4,'Nesca   All Type Of Women Artificial Jewelery Especially Oxidised Jewelery','.jpeg')
insert into tblProductImages values(4,'Nesca   All Type Of Women Artificial Jewelery Especially Oxidised Jewelery','.jpeg')
...
insert into tblProductSizeQuantity values(1,3,12)
...
insert into tblSizes values('Medium',3,3,4,2)
select * from tblUsers
...
cross apply(
select top 1 * from tblProductImages B where B.PID= A.PID order by B.PID desc
)B where t2.CatName='Neckpiece' or t2.CatName='Sonata'or t2.CatName='Pants'
order by A.PID desc
